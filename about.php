...
<head>
    ...
    <title>About us - cuisine Insic</title>
...
<body style="background: linear-gradient(rgba(252,252,252,0.65), rgba(80,60,53,0.65) 0%, rgba(255,255,255,0.65) 47%, rgba(47, 23, 15, 0.65) 100%);">
    <h1 class="text-center text-white d-none d-lg-block site-heading"><span class="text-primary site-heading-upper mb-3">Une équipe de 3 ingénieurs talentueux</span><span class="site-heading-lower">INSIC CUISINE</span></h1>
                ...
                <div class="row">
                    <div class="col-lg-10 col-xl-9 mx-auto">
                        <div class="bg-faded rounded p-5">
                            <h2 class="section-heading mb-4"><span class="section-heading-upper">BELLE CUISINE, PLAISIR DE CUISINER</span><span class="section-heading-lower">Notre histoire</span></h2>
                            <p>Notre histoire commence en 2020 dans une contrée vosgienne avec 3 futurs ingénieur(e)s talentueux, nous avons décidé de mener le projet de créer une cuisine personnalisable de A à Z pour tout le monde à un coût abordable.</p>
                            <p
                                class="mb-0"><span>Nous vous garantissons&nbsp;</span><span>une conception sur mesure selon vos besoins et une fabrication 100% française avec des produits régionaux qui sauront mettre en valeurs vos plus beaux plats.</span></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="features-clean" style="background-color: rgba(255,255,255,0.57);">
        <div class="container" style="opacity: 1;text-align: left;">
            <div class="intro">
                <h2 class="text-center">Notre démarche</h2>
                <p class="text-center"></p>
            </div>
            <div class="row text-left features">
                <div class="col-sm-6 col-lg-4 item"><i class="fa fa-map-marker icon"></i>
                    <h3 class="name">Partout en France</h3>
                    <p class="description" style="color: rgb(33,49,58);font-family: Lora, serif;">Nous assurons la livraison et l'installation partout en France par nos soins. Cette proximité vous assures une garantie supplémentaire.</p>
                </div>
                <div class="col-sm-6 col-lg-4 item"><i class="material-icons icon">laptop</i>
                    <h3 class="name">Logiciel professionnel</h3>
                    <p class="description" style="color: #21313a;">Pour le développement de vos meubles, nous utilisons les meilleurs logiciels professionnels. Catia, Blender, SolidWorks...</p>
                </div>
                <div class="col-sm-6 col-lg-4 item"><i class="far fa-smile icon"></i>
