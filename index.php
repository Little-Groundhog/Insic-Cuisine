...
<head>
    ...
    <title>Home - cuisine Insic</title>
            ...
            <div class="row">
                <div class="col-xl-9 mx-auto">
                    <div class="cta-inner text-center rounded">
                        <h2 class="section-heading mb-4"><span class="section-heading-upper">Notre promesse</span><span class="section-heading-lower">C'est vous</span></h2>
                        <p class="mb-0">Quand vous allez chez des amis et qu'ils vous présentent leurs magnifiques cuisines, vous vous dites pourquoi pas moi ? Et si j'avais aussi une superbe cuisine ?&nbsp;<br><br>Nous vous proposons de faire encore mieux...<br><br>Au-delà
                            de réaliser une cuisine selon vos souhaits et vos inspirations nous allons réaliser une cuisine selon vos besoins et vos envies en vous conseillant pas à pas de la conception à la réalisation !&nbsp;<br>Nous formons désormais
                            une équipe, bienvenue compagnon !</p>
                    </div>
                </div>
            </div>
        </div>
