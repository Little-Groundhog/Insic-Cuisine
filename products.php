...
<head>
    ...
    <title>Products - cuisine Insic</title>
...
<body style="background: linear-gradient(rgba(72,69,69,0.65) 0%, rgba(255,255,255,0.65) 0%, rgba(47, 23, 15, 0.65));">
    <h1 class="text-center text-white d-none d-lg-block site-heading"><span class="text-primary site-heading-upper mb-3">LES MEILLEURS MEUBLES POUR VOUS</span><span class="site-heading-lower" style="color: rgb(45,45,45);">INSIC CUISINE</span></h1>
    ...
    <section class="page-section">
        <div class="container">
            <div class="product-item">
                ...
                </div><img class="img-fluid d-flex mx-auto product-item-img mb-3 mb-lg-0 rounded" src="assets/img/cuisine-design-home.jpg" alt="cuisine-exemple">
    ...
    <section class="page-section">
        <div class="container">
            <div class="product-item">
                ...
                </div><img class="img-fluid d-flex mx-auto product-item-img mb-3 mb-lg-0 rounded" src="assets/img/table_lampe.jpg" alt="cuisine-exemple">
                <div class="bg-faded p-5 rounded">
    ...
    <section class="page-section">
        <div class="container">
            <div class="product-item">
                ...
                </div><img class="img-fluid d-flex mx-auto product-item-img mb-3 mb-lg-0 rounded" src="assets/img/travail_equipe.jpg" alt="travail-equipe">
                <div class="bg-faded p-5 rounded">
